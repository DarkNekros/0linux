...
while [ 0 ]; do
	...
	echo "dépôt des paquets de 0Linux. Celui-ci doit contenir le répertoire '${VERSION}'"
	echo "désignant la version de 0Linux, contenant la hiérarchie suivante :"
	echo ""
	echo "Vous avez :       /mes_paquets/0linux/${VERSION}/$(uname -m)/paquets.db"
	echo "Vous indiquerez : /mes_paquets/0linux"
	echo ""
